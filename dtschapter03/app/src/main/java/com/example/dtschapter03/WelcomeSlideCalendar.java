...
public class WelcomeSlideCalendar extends AppCompatActivity {
    ...
    public void clickContactUs(View view) {
        ...
        i.putExtra(Intent.EXTRA_TEXT, "Welcome to dts 2022");
        i.putExtra(Intent.EXTRA_CC, new String[]{"2041720013@student.polinema.ac.id"});
        i.putExtra(Intent.EXTRA_BCC, new String[]{"mirelldee47@gmail.com"});
