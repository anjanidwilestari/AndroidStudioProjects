...
public class WelcomeBack extends AppCompatActivity {
    ...
    private static final String DUMMY_USERNAME = "anjani@gmail.com";
    private static final String DUMMY_PASSWORD = "anjani";
    ...
    public void postLogin(View view) {
        ...
        // Validasi inputan tipe email
            ...
            Toast.makeText(this, "Username atau Password Invalid!", Toast.LENGTH_LONG).show();
        }
    ...
    public void postHome(View view) {
        Intent i = new Intent(WelcomeBack.this, WelcomeSlideCalendar.class);
        startActivity(i);
    }
