...
public class SuccessActivity extends AppCompatActivity implements ContactAdapter.OnContactClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listContact.add(new Contact("Batman",
                "102018309",
    ...
    public void onClick(View view, int position) {
        ...
        if(position==0){
            Intent i = new Intent(SuccessActivity.this, Slide0.class);
            startActivity(i);
        }
        else if(position==1){
            Intent i = new Intent(SuccessActivity.this, Slide1.class);
            startActivity(i);
        }
        else if(position==2){
            Intent i = new Intent(SuccessActivity.this, Slide2.class);
            startActivity(i);
        }
        else if(position==3){
            Intent i = new Intent(SuccessActivity.this, Slide3.class);
            startActivity(i);
        }
    }
